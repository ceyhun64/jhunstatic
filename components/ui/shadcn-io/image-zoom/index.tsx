...
export const ImageZoom = ({
  ...
  // react-medium-image-zoom reaches for the browser's `Element` global during
  // its own render, which crashes Next's server render (no DOM in Node).
  // Render the plain image on the server/first paint and only mount the
  // zoom-enabled wrapper once we're safely on the client.
